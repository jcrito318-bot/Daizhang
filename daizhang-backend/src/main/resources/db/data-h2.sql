...
-- ============================================
MERGE INTO `ai_accounting_rule` (`id`, `account_set_id`, `keyword`, `debit_subject_code`, `debit_subject_name`, `credit_subject_code`, `credit_subject_name`, `voucher_summary`, `priority`, `hit_count`, `enabled`, `deleted`, `version`, `create_by`, `create_time`, `update_by`, `update_time`) KEY (`id`) VALUES
...
-- ============================================
MERGE INTO `tax_benchmark` (`id`, `industry_code`, `industry_name`, `vat_benchmark_rate`, `vat_warning_low`, `vat_warning_high`, `eit_benchmark_rate`, `eit_warning_low`, `eit_warning_high`, `deleted`, `version`, `create_by`, `create_time`, `update_by`, `update_time`) KEY (`id`) VALUES
