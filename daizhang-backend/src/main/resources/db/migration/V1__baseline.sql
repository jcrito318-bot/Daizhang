-- ============================================
-- V1__baseline.sql - 基线 Schema (全部 DDL)
-- ============================================
-- 来源: schema-h2.sql (H2 兼容版, MODE=MySQL)
-- 变更:
--   1. 移除 CREATE TABLE 的 IF NOT EXISTS (Flyway 规范: 迁移应确定性执行)
--   2. 将 ALTER TABLE ADD COLUMN 的列合并进 CREATE TABLE (全新数据库兼容)
--   3. 移除 ALTER TABLE 语句 (列已合并, 无需后续修补)
--   4. 排除 V3-V7 增量表 (voucher_template, abstract_library,
--      ai_accounting_rule, ai_recognition_feedback, user_account_set_preference,
--      bank_match_history, tax_benchmark)
-- 兼容: H2 (MODE=MySQL) + MySQL 8.0+
-- ============================================
...
-- 资产盘点明细表
CREATE TABLE `ast_stocktake_detail` (
  `id` BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
CREATE TABLE `cst_customer` (
  ...
  `customer_status` TINYINT DEFAULT 1 COMMENT '客户状态 0-潜在 1-在服 2-流失',
...
CREATE TABLE `cst_billing_record` (
  `id` BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `customer_id` BIGINT NOT NULL COMMENT '客户ID',
...
CREATE TABLE `acc_voucher_template_detail` (
...
CREATE TABLE `acc_auxiliary_category` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `account_set_id` BIGINT NOT NULL COMMENT '账套ID(0-全局)',
...
CREATE TABLE `acc_auxiliary_item` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `account_set_id` BIGINT NOT NULL COMMENT '账套ID',
...
CREATE TABLE `acc_voucher_attachment` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `voucher_id` BIGINT NOT NULL COMMENT '凭证ID',
...
CREATE TABLE `doc_input_invoice` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `account_set_id` BIGINT NOT NULL COMMENT '账套ID',
  `invoice_code` VARCHAR(50) DEFAULT NULL COMMENT '发票代码',
...
CREATE TABLE `doc_output_invoice` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `account_set_id` BIGINT NOT NULL COMMENT '账套ID',
  `invoice_code` VARCHAR(50) DEFAULT NULL COMMENT '发票代码',
  `invoice_number` VARCHAR(50) NOT NULL COMMENT '发票号码',
...
CREATE TABLE `biz_service_flow_node` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cst_service_report` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `account_set_id` BIGINT NOT NULL COMMENT '账套ID',
  `customer_id` BIGINT DEFAULT NULL COMMENT '客户ID',
...
CREATE TABLE `rpt_custom_report` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `rpt_custom_report_item` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `acc_amortization` (
  ...
  `update_by` BIGINT DEFAULT NULL,
  `update_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `last_amortized_period` VARCHAR(7) DEFAULT NULL COMMENT '最近摊销期间(yyyy-MM)',
  PRIMARY KEY (`id`),
...
CREATE TABLE `sal_salary_formula` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `account_set_id` BIGINT NOT NULL COMMENT '账套ID',
...
CREATE TABLE `sal_social_security_config` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `account_set_id` BIGINT NOT NULL COMMENT '账套ID',
  `year` INT NOT NULL COMMENT '年度',
...
-- 个税专项附加扣除表
CREATE TABLE `sal_special_deduction` (
  `id` BIGINT NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `account_set_id` BIGINT NOT NULL COMMENT '账套ID',
  `employee_id` BIGINT NOT NULL COMMENT '员工ID',
...
CREATE TABLE `acc_multi_column_config` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `account_set_id` BIGINT NOT NULL COMMENT '账套ID',
  `subject_id` BIGINT NOT NULL COMMENT '科目ID',
  `subject_code` VARCHAR(50) NOT NULL COMMENT '科目编码',
...
CREATE TABLE `sys_industry_template` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `cst_portal_account` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `customer_id` BIGINT NOT NULL COMMENT '客户ID',
  `account_set_id` BIGINT NOT NULL COMMENT '账套ID',
...
CREATE TABLE `sys_employee_performance` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
-- 现金流量表调整表
-- ============================================
CREATE TABLE `rpt_cash_flow_adjustment` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
